...
class TDClient():
    ...
    def __repr__(self) -> str:
        ...
        # define the string representatiself.state['access_token']
    ...
    def _headers(self, mode: str = None) -> dict:
        ...
        bear_token = 'Bearer {token}'.format(token = self.state['access_token'])

        # create the headers dictionary
        headers = {
            'Authorization': bear_token
        }
        #print("AYOOO found that access token:" + bear_token)
